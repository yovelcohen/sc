...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Account',
            fields=[
                ('id', models.CharField(help_text='Account ID', max_length=100, primary_key=True, serialize=False)),
                ('name', models.CharField(default='default_account', max_length=255)),
                ('zoura_subscription_id', models.CharField(blank=True, max_length=100, null=True)),
                ('zoura_billing_account_id', models.CharField(blank=True, max_length=100, null=True)),
